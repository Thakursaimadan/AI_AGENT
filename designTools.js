...
export const DESIGN_OPTIONS = {
  ...
  appearance_background: ['none', 'solid', 'gradient', 'image','video','dualcolor'],
...
export const LAYOUT_DEFINITIONS = {
  classic: {
    ...
    "Profile_Section": "Circular profile photo prominently displayed at the top center",
    "Username": "Centered below the profile photo",
    "Navigation": "Buttons arranged horizontally below the username",
    "Content_Area": "Multiple horizontal rectangular sections stacked vertically below the navigation",
    "Layout_Structure": "Symmetrical, top-to-bottom flow with centered alignment",
    "Overall_Feel": "Professional, traditional, and straightforward - similar to a standard social media profile layout",
    "Best_For": "Users who prefer clean, professional aesthetics without distractions"
  },
  compact: {
    "Visual_Style": "Space-efficient design with high information density",
    "Profile_Section": "Smaller circular profile photo positioned in the upper left corner",
    ...
    "Content_Area": "Distinct rectangular input/content fields with defined borders",
    "Layout_Structure": "Condensed layout maximizing vertical space usage",
    "Overall_Feel": "Modern, streamlined, and mobile-optimized",
    "Best_For": "Users who want maximum information density and mobile-first experience"
  },
  banner: {
    ...
    "Username": "Centered below the profile photo",
    "Navigation": "Buttons arranged horizontally below the username",
    "Content_Area": "Multiple horizontal banner-style sections with consistent spacing",
    "Layout_Structure": "Similar to classic but with more emphasis on horizontal sections and also additionally can add a banner image",
    "Overall_Feel": "Balanced between professional and casual, moderate visual weight",
    "Best_For": "Users who want a middle ground between bold and subtle aesthetics and want upload a banner image"
  },
  image: {
    "Visual_Style": "Image-centric design with asymmetrical layout",
    "Profile_Section": "Large portrait photo taking up significant space on one side of the layout",
    ...
    "Content_Area": "Content sections arranged around the prominent profile image",
    "Layout_Structure": "Asymmetrical design with image as the primary focal point",
    "Overall_Feel": "Personal, visually striking, and brand-focused",
    "Best_For": "Users who want to showcase their personality/brand through photography and prefer eye-catching, unique layouts"
  }
};
...
export const getClientDesign = async (clientId) => {
    ...
    if (banner_library_id) {
        ...
        if (background_library_id) {
          ...
          console.log('Fetched design for client:', clientId, 'Banner URL:', banner_mediaUrl, 'Background URL:', background_mediaUrl);
